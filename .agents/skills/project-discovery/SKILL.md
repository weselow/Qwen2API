...
description: Analyze existing project and extract conventions, patterns, and architecture into .Codex/rules/project-conventions.md
user-invocable: true
---

# Project Discovery

Analyze an existing project codebase and extract everything needed for effective development into `.Codex/rules/project-conventions.md`.

## When to Use

- First time working with an existing project
- After major architectural changes
- When AGENTS.md conventions feel outdated
...
Write all findings to `.Codex/rules/project-conventions.md` in this format:
...
> Extracted project conventions to `.Codex/rules/project-conventions.md`.
...
- If `.Codex/rules/project-conventions.md` already exists, show the user what changed and ask before overwriting.
